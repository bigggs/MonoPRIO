...
class Trainer(object):
    def __init__(self,
        ...
        self.tester = None
        self.eval_start_epoch = int(cfg.get('eval_start_epoch', 0))
        self.eval_interval = int(cfg.get('eval_interval', 1))
    ...
    def _should_eval(self, epoch):
        if epoch < self.eval_start_epoch:
            return False
        return ((epoch - self.eval_start_epoch) % self.eval_interval) == 0
    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.cfg['max_epoch']):
            ...
            if (self.epoch % self.cfg['save_frequency']) == 0:
                ...
                if self.tester is not None and self._should_eval(self.epoch):
    ...
    def train_one_epoch(self, epoch):
        ...
        for batch_idx, (inputs, calibs, targets, info) in enumerate(self.train_loader):
            ...
            mask_dict=None
            #ipdb.set_trace()
            detr_losses_dict = self.detr_loss(outputs, targets, mask_dict, epoch=epoch)
